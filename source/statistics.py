...
def get_statistics(bw_aln, bow_aln, bw_mis, bow_mis, bw_un, bow_un, bw_pre, bow_pre, bw_rec, bow_rec, bw_fs, bow_fs, path):
    stats = [[],[],[],[],[],[]]
    for i in range(5):
    ...
    mux = pd.MultiIndex.from_product([['Set 1','Set 2','Set 3', 'Set 4', 'Set 5'], ['BWA MEM','Bowtie']])
...
def set_errors_table():
    ...
    error_sets = {'Set 1' : [0, 0, 0], 'Set 2' : [0.009, 0.009, 0.009], 'Set 3' : [0.09, 0, 0], 'Set 4' : [0, 0.03, 0.03], 'Set 5' : [0.03, 0.03, 0.03]}
    ...
    style_df.format(precision = 2, formatter = {'Set 2' : "{:.3f}"})
